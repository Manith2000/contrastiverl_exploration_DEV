...
def get_default_logger_fn(
    ...
    def create_logger(actor_id):
        return make_wandb_logger(
            ...
            init_wandb=False,
        )  # Don't init wandb in actor loggers
...
class CheckpointingConfig:
    def __init__(self, save_dir="logs", add_uid=True):
